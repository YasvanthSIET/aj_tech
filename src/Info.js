            ...
            <div className="row mt-4">
                ...
                <div className="col-md-8 col-xl-3" id="con">
                    <div>
                        ...
                        <p>Dominate the Digital Landscape with AJ InfoTeck 's Expert Marketing Strategies. Your Gateway to Digital Success Find out the key to the World</p>
                ...
                <div className="col-md-8 col-xl-3" id="con">
                    <div>
                        <h5>Address</h5>
                        <address>13/1A, 2nd Floor,<br />STC College Road,<br />Perumalpuram,<br />Tirunelveli - 627 007,<br />Tamil Nadu.</address>
                    </div>
                </div>
            </div>
        </div>
